...
<img src="{{ site.baseurl }}/assets/images/ingest_flow.png" width="623" height="360" alt="Dataflow diagram of ingest of job data from MongoDB to the XDMoD datawarehouse"/>
